...
@section('content')
    <div class="content-fluid mt-3">
        <div class="card card-secondary card-tabs bg-light">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('marcas.update', ['id' => $marca->id]) }}" id="form"
                            ...
                            <div class="card mb-3 mx-auto" style="max-width: 80%;">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4 p-3">
                                        ...
                                        <img src="{{ asset('storage/marcas') . '/' . $marca->imagen }}"
                                            alt="{{ $marca->nombre }}" class="img-fluid rounded-start mb-3">
    ...
    <form action="{{ route('marcas.destroy', $marca->id) }}" method="POST" style="display: inline" id="deleteForm">
        @csrf
        @method('DELETE')
    </form>
@endsection
