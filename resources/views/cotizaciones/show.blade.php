...
@section('content')
    <div class="row justify-content-between">
        <div class="col text-center">
            <h3>
                <strong>
                    IMPORTACIONES E INVERSIONES CYH S.A.S
                </strong>
            </h3>
            <h4>
                <strong>
            ...
            <small>TELÉFONO 8012642 - 3103311634</small><br>
            <small>importacioneseinversionescyh@gmail.com</small><br>
            <small>Bogotá, Colombia</small>
        </div>
        <div class="col text-center">
            <img src="{{ asset(config('adminlte.logo_img')) }}" alt="{{ config('adminlte.logo_img_alt') }}" height="400">
        </div>
    </div>
