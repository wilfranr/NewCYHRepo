                            ...
                            <tbody>
                                @foreach ($listas as $lista)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('listas.edit', $lista->id) }}">{{ $lista->definicion }}</a>
                                        </td>
                                        <td>
                                            <a href="{{ asset('storage/listas/' . $lista->foto) }}" target="_blank">
                                                <img src="{{ asset('storage/listas/' . $lista->foto) }}"
                                                    alt="{{ $lista->nombre }}" width="100">
                                            </a>
                                        </td>
                                        <td><a
                                                href="{{ route('listas.edit', $lista->id) }}">{{ optional($lista->created_at)->format('d/m/Y') }}</a>
                                        </td>
